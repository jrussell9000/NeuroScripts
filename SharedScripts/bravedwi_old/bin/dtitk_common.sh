...
# ASF-added
# reg=(   0  0.022 0.018 0.014 0.012 0.010 0.005 )
# prior=( 0  0.060 0.050 0.040 0.030 0.020 0.010 )
...
echo Running DTI-TK for $DTITK_SPECIES
