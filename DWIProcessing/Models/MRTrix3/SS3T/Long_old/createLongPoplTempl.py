...
def copy2intrasubtempl_dir(subj_dir):
    ...
    ses01wmfod_orig = subj_dir / 'ses-01' / 'dwi' / 'processed' / (subj_dir.name + '_ses-01_wmfod_norm.mif')
    ses02wmfod_orig = subj_dir / 'ses-02' / 'dwi' / 'processed' / (subj_dir.name + '_ses-02_wmfod_norm.mif')

    ses01mask_orig = subj_dir / 'ses-01' / 'dwi' / 'processed' / (subj_dir.name + '_ses-01_mask_ppd.mif')
    ses02mask_orig = subj_dir / 'ses-02' / 'dwi' / 'processed' / (subj_dir.name + '_ses-02_mask_ppd.mif')
