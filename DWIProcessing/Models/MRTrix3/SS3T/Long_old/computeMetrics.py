...
fixelmask_dir = Path('/scratch/jdrussell3/dti_longproc/fixel_mask')
FD_dir = Path('/scratch/jdrussell3/dti_longproc/FD')
FC_dir = Path('/scratch/jdrussell3/dti_longproc/FC')
logFC_dir = Path('/scratch/jdrussell3/dti_longproc/logFC')
FDC_dir = Path('/scratch/jdrussell3/dti_longproc/FDC')
