...
rs_dir = Path('/fast_scratch/jdr/resting/workingAFNI/resting/amyghipp2gm')
mni_mask_2mm = Path('/fast_scratch/jdr/resting/wb_masks/MNI_mask_2mm+tlrc.')
amygmasks_dir = Path('/fast_scratch/jdr/resting/masks/hippAmyg')
...
def netproc(nii):
    ...
    for amygmask in amygmasks_dir.glob('*.nii'):
        ...
        subprocess.run(['3dNetCorr', '-inset', masked_out, '-mask',
                        '/Volumes/Vol6/YouthPTSD/ROIs/AFNI_Anat_Masks/MNI152_T1_2mm_grayMatter.nii', '-in_rois', amygmask,
