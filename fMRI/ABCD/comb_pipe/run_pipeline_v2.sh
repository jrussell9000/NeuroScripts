...
schaeferTian_label="/fast_scratch/jdr/atlases/TianSubcortical/Schaefer2018_400Parcels_7Networks_order_Tian_Subcortex_S4.dlabel.nii"
pconnout_dir="/fast_scratch/jdr/ABCD/ABCD_3165_Pipe/pconns"
cifticonn="${SCRIPT_DIR}/cifti_conn_wrapper.py"
