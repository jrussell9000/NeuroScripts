...
main() {
	...
	eddy_command+="${verbose} "
	eddy_command+="${ReplOutliers} "
	...
	eddy_command+="--bvecs=${PREPROC_DIR}/PA_AP.bvec "
	eddy_command+="--bvals=${PREPROC_DIR}/PA_AP.bval "
	eddy_command+="--topup=${PREPROC_DIR}/topup_PA_AP_b0 "
